...
The debug APK is generated at `apk output/Earth_Movers-debug.apk`. Android builds require JDK 21 and an Android SDK. The currently deployed Worker version is `cb2c7b9a-22d4-4953-b5f0-5f04f2bbd074`.
