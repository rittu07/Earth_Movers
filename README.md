...
The debug APK is generated at `apk output/Earth_Movers-debug.apk`. Android builds require JDK 21 and an Android SDK. The currently deployed Worker version is `ccf30c6e-a6b3-454b-9a5f-1d73710d9fc1`.
